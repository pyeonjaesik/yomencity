var t_addh12 = function(id,name,img,ct){
  ...
  img_c.css({'position':'absolute','top':'12.5px','left':'5px','width':'50px','height':'50px','overflow':'hidden','border-radius':'50%'});
    ...
    img.each(function(){
        ...
        div.append(div_c);
        post_t2_scroll_h2-=9925;
    });    
};
var t_addh22 = function(id,name,img,post_id,ct){ 
  var post_id = post_id;    
  var id =id;
  var name = name;
  var img = img;
...
var t_addh32 = function(id,name,img,post_id,comment_id,ct){    
  var div = $('<div></div>');
  div.css({'position':'relative','top':'0','left':'0','width':'100%','height':'75px',background:'white','overflow':'hidden'});
  div.addClass('t_add_h2');
  var id =id;
...
var t_addh42 = function(id,name,img,post_id,ct){  
  var div = $('<div></div>');
