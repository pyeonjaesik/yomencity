var addh1 = function(id,name,img,ct){
  var div = $('<div></div>');
...
if(img =='1'){
  ...
  img_c.css({'position':'absolute','top':'12.5px','left':'5px','width':'50px','height':'50px','overflow':'hidden','border-radius':'50%'});
    ...
    img.each(function(){
        ...
        div.append(div_c);
        post52_scroll_h-=9925;
    });    
};
var addh2 = function(id,name,img,post_id,ct){ 
  var post_id = post_id;    
  var id =id;
  var name = name;
  var img = img;
...
var addh3 = function(id,name,img,post_id,comment_id,ct){    
  var div = $('<div></div>');
  div.css({'position':'relative','top':'0','left':'0','width':'100%','height':'75px',background:'white','overflow':'hidden'});
  div.addClass('add_h');
  var id =id;
...
var addh4 = function(id,name,img,post_id,ct){  
  var div = $('<div></div>');
